...
Overview
This repository contains the base code and workflow structure used to develop the scientific report “Mapping the Heat Divide: Spatio Temporal Analysis of Thermal Hotspots and Socio Economic Inequality in Dhaka (2014–2024)”. The current version documents the analytical pipeline and includes the main notebooks, scripts, and selected intermediate outputs.
...
Classified LST Trends Based on Theil–Sen Slope (2014–2024)

Purpose of This Repository
This draft repository serves three goals:
1.	Transparency – to show the structure of the analytical workflow used in the report.
2.	Documentation – to outline how Landsat/MODIS LST, trend analysis, hotspot detection, and poverty heat linkage were implemented.
3.	Reproducibility (Final Version) – the complete, cleaned workflow will be delivered with the final submission.
...
o	harmonised functions
o	consistent plotting styles
o	complete documentation
o	reproducible outputs for all figures in the report
...
Data Availability
Satellite datasets (Landsat 8/9, MODIS) are accessed through Google Earth Engine. Socio economic datasets (EDSO 2017, NB_BUDENS) are not included in this repository due to licensing and size constraints.
