{
 "cells": [
  {
   ...
   "metadata": {
    "executionInfo": {
     "elapsed": 24981,
     "status": "ok",
     "timestamp": 1769604162399,
     "user": {
      "displayName": "Mahbubul Alam",
      "userId": "07960849238327218944"
     },
     "user_tz": -60
    },
    "id": "w9fwbxgoPiMM"
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "RbkFCuqfo3kh",
    "outputId": "93677888-5dc0-4751-8d7c-f1ff2be32504"
   },
   "outputs": [
    {
     "data": {
    ...
    },
    {
     ...
     "text": [
      "\n",
      "===============================================\n",
      "   GEE DATA PRECHECK: Dhaka Heat–Poverty Project\n",
      "===============================================\n",
      "\n",
      "[OK] Poverty dataset (EO4SD) loaded successfully (1624 features).\n",
      "[OK] Poverty dataset (EO4SD) contains all required properties.\n",
      "[OK] Dhaka boundary loaded successfully (41 features).\n",
      "[OK] Dhaka boundary contains all required properties.\n",
      "[OK] Landsat 8 (LC08) loaded (1700918 images).\n",
      "[OK] Landsat 8 (LC08) contains all required bands.\n",
      "[OK] Landsat 9 (LC09) loaded (479936 images).\n",
      "[OK] Landsat 9 (LC09) contains all required bands.\n",
      "\n",
      "===============================================\n",
      "   GEE DATA PRECHECK COMPLETE\n",
      "===============================================\n",
      "\n"
     ]
    }
 ...
 "metadata": {
  "colab": {
   "authorship_tag": "ABX9TyOK291IcQOyj/1m2IDI3QyN",
   "mount_file_id": "1RcpABXhJoORq60bKj4EYoT9SmhlttYzP",
   "provenance": []
  },
  "kernelspec": {
